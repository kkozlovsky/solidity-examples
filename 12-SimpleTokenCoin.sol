...
contract SimpleTokenCoin is Ownable {
    ...
    function transfer(address _to, uint _value) public returns (bool success) {
        if (balances[msg.sender] >= _value && balances[msg.sender] + _value >= balances[msg.sender]) { // && защита от переполнения
...
// http://inaword.ru/blokchejn/pishem-smart-kontrakt-ethereum-eto-prosto-chast-5-token-erc20/